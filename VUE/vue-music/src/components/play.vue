    ...
    >
      ...
      <div class="normal-player" v-show="fullScreen">
        ...
        <div class="top">
          ...
          <!-- v-html就是用来给标签添加text内容-->
          <h2
            class="subtitle"
            v-html="(currentSong.ar && currentSong.name) || (currentSong.artists && currentSong.artists[0].name)"
          ></h2>
        </div>
        <!-- 播放页面的内容 -->
        <div
...
export default {
  ...
  methods: {
    ...
    ready() {
      ...
      // 监听playing事件确保慢网速或者快速切换歌曲导致的 DOM exceotion
      this.songReady = true;
