        ...
        >
           <div class="normal-player" v-show="fullScreen">
               <div class="background">
                   <img height="100%" width="100%" :src="(currentSong.al&&currentSong.al.picUrl)||(currentSong.artists&&currentSong.artists[0].img1v1Url)" alt="">
               </div>
               <!-- 播放页面头部 -->
               <div class="top">
                    ...
                    <div class="middle-l" ref="middleL">
                        <div class="cd-wrapper" ref="cdWrapper">
                            <div class="cd" ref="imageWrapper">
                                <img 
                                :src="(currentSong.ar && currentSong.ar.picUrl) || (currentSong.artists && currentSong.artists[0].img1v1Url)" 
                                alt=""
                                ref="image"
                                :class="cdCls"
                                class="image"
        ...
        <transition name="mini">
            <div class="mini-player" v-show="!fullScreen" @click="open" >
                ...
                <div class="text">
                    ...
                    <p class="desc" v-html="(currentSong.ar && currentSong.a[0].name) || (currentSong.artists && currentSong.artists[0].name)"></p>
                </div>
                <div class="control">
    ...
    .play
        ...
        .normal-player
            ...
            .middle
                ...
                bottom px2rem(340px)
                white-space nowrap
                font-size 0 // 让父元素大小完全由子元素撑开 子元素互相没有间距
                &-l
